  ...
  return (
    <main>
        <section className="bg-primary">
            <Header />
            <div className="pt-[62px] pb-24 px-5 md:px-0 md:pt-[60px] md:pb-20 flex flex-col items-center gap-y-[36px] md:gap-y-4 mx-auto md:max-w-[760px] text-center">
        ...
        <section className="mx-auto md:max-w-[720px] lg:max-w-[1280px] w-full pt-0 pb-0 md:pb-10 md:pt-20 flex flex-col gap-0 md:gap-y-12 overflow-hidden">
